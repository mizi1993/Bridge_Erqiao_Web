...
initializeWindows = function(){
	...
	if ($('AboutLinkMenu')) {
		$('AboutLinkMenu').addEvent('click', function(e){
			new Event(e).stop();
			MUI.aboutWindow();
		});
	}
...
initializeColumns = function() {
	...
	new MUI.Panel({
		id: 'files-panel',
		title: '导航菜单',		
		contentURL: '../includes/SystemFunctionListDemo.aspx',
		column: 'sideColumn1',
		require: {
		...
		onContentLoaded: function(){		
			...
			if ($('HelpOnline')) {
				$('HelpOnline').addEvent('click', function(e){
				new Event(e).stop();
					MUI.HelpOnlineWindow();
				});
			}

//弹出Dlg
	        MUI.TestWindow = function(sID,sTitle,sURL,iWid,iHei) {
		        new MUI.Window({
			        id: sID,
			        title: sTitle,
			        loadMethod: 'iframe',						
	        ...
	        MUI.Test2Window = function(sID,sTitle,sURL,iWid,iHei) {
		        new MUI.Window({
			        id: sID,
			        title: sTitle,
			        loadMethod: 'iframe',
	        ...
	        MUI.Test3Window = function(sID,sTitle,sURL,iWid,iHei,ix,iy) {
		        new MUI.Window({
			        id: sID,
			        title: sTitle,
			        loadMethod: 'iframe',
	        ...
	        MUI.TabWindow = function(sID,sTitle,iWid,iHei,sToolbarUrl,sTabUrl1) {
		        new MUI.Window({
			id: sID,
			title: sTitle,
			loadMethod: 'iframe',
...
*/
	...
	new MUI.Panel({
		...
		title: '操作区',
        loadMethod: 'iframe',
		contentURL: '../MapGisDemo.aspx',
		//contentURL: '../Web3D/WebPlayer.html',
		column: 'mainColumn',
		headerToolbox: true,
...
//							loadMethod: 'iframe',
//		title: '视频联动窗口',
//		contentURL: '../Video/VideoInMain.aspx',
//		column: 'sideColumn2',
//		height: 160
//	});	
...
function OpenDlg(sID,sTitle,sURL,iWid,iHei)
{
    MUI.TestWindow(sID,sTitle,sURL,iWid,iHei);
}

function OpenWin(sID,sTitle,sURL,iWid,iHei)
{
    MUI.Test2Window(sID,sTitle,sURL,iWid,iHei);
}

function OpenPop(sID,sTitle,sURL,iWid,iHei,ix,iy)
{
    MUI.Test3Window(sID,sTitle,sURL,iWid,iHei,ix,iy);
}