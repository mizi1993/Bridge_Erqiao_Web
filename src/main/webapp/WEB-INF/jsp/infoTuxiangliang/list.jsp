...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<s:form method="post" action="" id="form1">
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="style1">混凝土箱梁定期检查结果管理</td>
				<td align="right"><s:a cssClass="Button"
						action="infoTuxiangliang_addUI?taskId=%{#task.id}"
		...
		<div>
			<table cellspacing="0" cellpadding="3" align="Center" rules="all"
				...
				<tr class="TdTitle">
					...
					<th scope="col">时间</th>
					<th scope="col">梁段位置</th>
					<th scope="col">缺陷位置</th>
					<th scope="col">缺陷类型</th>
					<th scope="col">缺陷范围</th>
					<th scope="col">等级</th>
					<th scope="col">养护意见</th>
