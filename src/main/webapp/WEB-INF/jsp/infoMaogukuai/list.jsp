...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<form id="myForm" method="post" id="form1" action="">
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="style1">锚固块定期检查结果管理</td>
				<td align="right"><s:a cssClass="Button"
						action="infoMaogukuai_addUI?taskId=%{#task.id}"
		...
		<div>
			<table cellspacing="0" cellpadding="3" align="Center" rules="all"
				...
				<tr class="TdTitle">
					...
					<th scope="col">位置</th>
					<th scope="col">类型</th>
					<th scope="col">体外预应力索编号</th>
					<th scope="col">钢构件掉漆生锈</th>
					<th scope="col">钢构件变形开裂</th>
					<th scope="col">混凝土</th>
					<th scope="col">锚栓</th>
					<th scope="col">胶层</th>
