...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<form id="myForm" method="post" id="form1" action="">
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="style1">斜拉索下锚头桥面以下定期检查结果管理
				</td>
				<td align="right"><s:a cssClass="Button"
						action="infoXiamaotouDown_addUI?taskId=%{#task.id}"
		...
		<div>
			<table cellspacing="0" cellpadding="3" align="Center" rules="all"
				...
				<tr class="TdTitle">
					...
					<th scope="col">积水排水情况</th>
					<th scope="col">砼箱梁锚块砼等级</th>
					<th scope="col">砼梁锚固区等级</th>
					<th scope="col">锚头及垫板清理除锈</th>
					<th scope="col">其它</th>
