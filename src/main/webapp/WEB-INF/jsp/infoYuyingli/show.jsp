...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<s:form id="form1" method="post"
		action="infoYuyingli_%{time== null ? 'add' : 'edit'}?taskId=%{#task.id}"
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="GridTitle"> 体外预应力索数据详细&编辑
</td>
			</tr>
		</table>
		...
		<table style="width: 100%;" cellpadding="2" cellspacing="1"
            ...
            <tr>
                ...
                <td height="25" width="30%" align="left">
                   ...
                   <s:textfield name="position" cssStyle="position:absolute;left:-2px; top: 0px; right: 245px;" /> 
               </div>
                </td>
                <td height="25" width="20%" align="right">
                    部位：
                ...
                <td height="25" width="30%" align="left">
                    ...
                    <select name="up_down" style="height:16px;width:150px;">
	...
	<option value="下游">下游</option>
            ...
            <tr>
                ...
                <td width="30%" align="left" class="style1">
                    <div style="position:relative;"> 
                   <s:textfield name="suotiDes" cssStyle="position:absolute;left:-2px; top: 0px; right: 243px;"/> 
               </div>
                </td>
                <td width="20%" align="right" class="style1">
                    编号：
                ...
                <td width="30%" align="left" class="style1">
                    <div style="position:relative;"> 
                   <s:textfield name="no" cssStyle="position:absolute;left:-2px; top: 0px; right: 243px;" /> 
               </div>
                </td>
            </tr>
            <tr>
                ...
                <td height="25" width="30%" align="left">
                    <div style="position:relative;"> 
                   <s:textfield name="maoguduanDes" cssStyle="position:absolute;left:-2px; top: 0px; right: 243px;"  /> 
               </div>
                </td>
                 <td height="25" width="20%" align="right">
                     环氧填充料：
                ...
                <td height="25" width="30%" align="left">
                    <div style="position:relative;">
                        <s:textfield name="tianchongliaoDes" cssStyle="position:absolute;left:-2px; top: 0px; right: 243px;"  />
                    </div>
                </td>
           </tr>
            <tr>
                ...
                <td height="25" width="30%" align="left">
                   ...
                   <s:textfield name="zhuanxiangqiDes" cssStyle="position:absolute;left:-2px; top: 0px; right: 243px;"  /> 
               </div>
						...
						<tr>
							...
							<td width="30%" colspan="3" align="center">
								<table style="width: 98%;" cellspacing="0" cellpadding="5"
									border="1" class="tableFrom">
									<tr>
							 <td align="center">索体</td>
                            <td align="center">张拉端，锚固端</td>
                            <td align="center">环氧填充料</td>
                            <td align="center">转向器</td>
