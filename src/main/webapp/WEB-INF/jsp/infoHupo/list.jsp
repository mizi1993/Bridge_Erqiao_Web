...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<form id="myForm" method="post" id="form1" action="">
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="style1">挡墙护坡定期检查结果管理</td>
				<td align="right"><s:a cssClass="Button"
						action="infoHupo_addUI?taskId=%{#task.id}"
		...
		<div>
			<table cellspacing="0" cellpadding="3" align="Center" rules="all"
				...
				<tr class="TdTitle">
					...
					<th scope="col">时间</th>
					<th scope="col">位置</th>
					<th scope="col">沉降等级</th>
					<th scope="col">墙体开裂等级</th>
					<th scope="col">填土有外溢等级</th>
					<th scope="col">坍塌等级</th>
