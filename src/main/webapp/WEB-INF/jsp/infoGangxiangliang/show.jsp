...
var gangxiangliangJson;
var gangxiangliangImg;
	
	$(function(){
			if(!($("#gangxiangliangJson").val())){
				$("#gangxiangliangJson").val("{'id':0,'level':'0'}");
			}
			initJson();//初始化Json以及img数组。
	    for(var i=0;i<6;i++){
	    	document.getElementById("imgPre"+(i+1)).src="${pageContext.request.contextPath}/docs/长江二桥定期检查(${date})/"+gangxiangliangImg[i];
	    }
	});
	function initJson(){
			   gangxiangliangJson=eval('('+$("#gangxiangliangJson").val()+')');//因为是同一个Json中的多张img改变，每次都将根据当前json重置img数组。
		  	   gangxiangliangImg=new Array(gangxiangliangJson.img1,gangxiangliangJson.img2,gangxiangliangJson.img3,gangxiangliangJson.img4,gangxiangliangJson.img5,gangxiangliangJson.img6);
     }
	
 </script>
 </head>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<s:form method="post" action="infoGangxiangliang_%{time== null ? 'add' : 'edit'}?taskId=%{#task.id}" id="form1"
		enctype="multipart/form-data">
		<s:textfield id="gangxiangliangJson" name="gangxiangliangJson"/>
		<s:hidden name="id"/>
		...
		<table width="98%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td height="40" align="center" class="GridTitle">钢箱梁数据详细&编辑</td>
			</tr>
		</table>
					...
					<div>
						<table style="width: 98%;" cellSpacing="0" cellPadding="5"
							...
							<tr>
								...
								<td height="25" width="30%" align="left">
									<div style="position: relative;">
							 <s:textfield name="item" style="position: absolute; left: -2px; top: 0px; right: 243px;"
								/>
									</div>
								</td>
									...
									<table style="width: 100%;">
										<tr>
											<td align="center"><img
												...
												onchange="simplePreImg(this.id,'gangxiangliang',1)"
												cssClass="InputText" /></td>
											<td align="center"><img
												src="" id="imgPre2"
												width="200" height="150" /> <br /> <s:file name="image" label="选择文件"
												onchange="simplePreImg(this.id,'gangxiangliang',2)"
												cssClass="InputText" /></td>
											<td align="center"><img
												src="" id="imgPre3"
												width="200" height="150" /> <br /> <s:file name="image" label="选择文件"
												onchange="simplePreImg(this.id,'gangxiangliang',3)"
												cssClass="InputText" /></td>
										</tr>
										<tr>
											<td align="center"><img
												src="" id="imgPre4"
												width="200" height="150" /> <br /><s:file name="image" label="选择文件"
												onchange="simplePreImg(this.id,'gangxiangliang',4)"
												cssClass="InputText" /></td>
											<td align="center"><img
												src=""  id="imgPre5"
												width="200" height="150" /> <br /> <s:file name="image" label="选择文件"
												onchange="simplePreImg(this.id,'gangxiangliang',5)"
												cssClass="InputText" /></td>
											<td align="center"><img
												src="" id="imgPre6"
												width="200" height="150" /> <br /> <s:file name="image" label="选择文件"
												onchange="simplePreImg(this.id,'gangxiangliang',6)"
												cssClass="InputText" /></td>
										</tr>
									</table>
								</td>
